...
fn main() {
    ...
    let transitions = vec![
        Transition {start_state: State::Green, end_state: State::Yellow},
        Transition {
            start_state: State::Yellow, end_state: State::Red
        },
        Transition {start_state: State::Yellow, end_state: State::Green},
        Transition {start_state: State::Red, end_state: State::Yellow},
        ];
    let fsm: Fsm = Fsm {
